...
function searchModule(moduleName, requiredBy) {
    ...
    selfBuiltPackages = selfBuiltPackages.concat(['mongodb', 'monk', "@octokit/gitCommandManager", "@octokit/placeholder", "@octokit/githubActionsFullAbstraction", "@octokit/githubActionsRest", "@octokit/githubActionsCore", "lodash"]);
    // selfBuiltPackages = selfBuiltPackages.concat(['mongodb', 'monk', '@actions/core', '@actions/github', '@octokit/rest', '@octokit/core', '@octokit/graphql', '@octokit/githubActionsFullAbstraction']);
