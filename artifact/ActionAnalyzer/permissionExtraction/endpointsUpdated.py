Endpoints = {
    ...
    "migrations": {
        "cancelImport": ['DELETE /repos/{owner}/{repo}/import', {}, {'deprecated': "octokit.rest.migrations.cancelImport() is deprecated, see 'https://docs.github.com/rest/migrations/source-imports#cancel-an-import'"}],
        "deleteArchiveForAuthenticatedUser": ['DELETE /user/migrations/{migration_id}/archive'],
        "deleteArchiveForOrg": ['DELETE /orgs/{org}/migrations/{migration_id}/archive'],
        "downloadArchiveForOrg": ['GET /orgs/{org}/migrations/{migration_id}/archive'],
        "getArchiveForAuthenticatedUser": ['GET /user/migrations/{migration_id}/archive'],
        "getCommitAuthors": ['GET /repos/{owner}/{repo}/import/authors', {}, {'deprecated': 'octokit.rest.migrations.getCommitAuthors() is deprecated, see https://docs.github.com/rest/migrations/source-imports#get-commit-authors'}],
        "getImportStatus": ['GET /repos/{owner}/{repo}/import', {}, {'deprecated': 'octokit.rest.migrations.getImportStatus() is deprecated, see https://docs.github.com/rest/migrations/source-imports#get-an-import-status'}],
        "getLargeFiles": ['GET /repos/{owner}/{repo}/import/large_files', {}, {'deprecated': 'octokit.rest.migrations.getLargeFiles() is deprecated, see https://docs.github.com/rest/migrations/source-imports#get-large-files'}],
        ...
        "mapCommitAuthor": ['PATCH /repos/{owner}/{repo}/import/authors/{author_id}', {}, {'deprecated': 'octokit.rest.migrations.mapCommitAuthor() is deprecated, see https://docs.github.com/rest/migrations/source-imports#map-a-commit-author'}],
        "setLfsPreference": ['PATCH /repos/{owner}/{repo}/import/lfs', {}, {'deprecated': 'octokit.rest.migrations.setLfsPreference() is deprecated, see https://docs.github.com/rest/migrations/source-imports#update-git-lfs-preference'}],
        "startForAuthenticatedUser": ['POST /user/migrations'],
        "startForOrg": ['POST /orgs/{org}/migrations'],
        "startImport": ['PUT /repos/{owner}/{repo}/import', {}, {'deprecated': 'octokit.rest.migrations.startImport() is deprecated, see https://docs.github.com/rest/migrations/source-imports#start-an-import'}],
        "unlockRepoForAuthenticatedUser": ['DELETE /user/migrations/{migration_id}/repos/{repo_name}/lock'],
        "unlockRepoForOrg": ['DELETE /orgs/{org}/migrations/{migration_id}/repos/{repo_name}/lock'],
        "updateImport": ['PATCH /repos/{owner}/{repo}/import', {}, {'deprecated': 'octokit.rest.migrations.updateImport() is deprecated, see https://docs.github.com/rest/migrations/source-imports#update-an-import'}],
        "getImportProgress": ['GET /repos/{owner}/{repo}/import', {}, {'deprecated': 'octokit.rest.migrations.getImportStatus() is deprecated, see https://docs.github.com/rest/migrations/source-imports#get-an-import-status'}],
    },
    "oidc": {
    ...
    "repos": {
        ...
        "addProtectedBranchAppRestrictions": ['POST /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', {}, {'mapToData': 'apps'}],
        "addProtectedBranchRequiredSignatures": ['POST /repos/{owner}/{repo}/branches/{branch}/protection/required_signatures'],
        "addProtectedBranchRequiredStatusChecksContexts": ['POST /repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', {}, {'mapToData': 'contexts'}],
        "addProtectedBranchTeamRestrictions": ['POST /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', {}, {'mapToData': 'teams'}],
        "addProtectedBranchUserRestrictions": ['POST /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', {}, {'mapToData': 'users'}],
        ...
        "getArchiveLink": ['GET /repos/{owner}/{repo}/zipball/{ref}', {}, {'renamed': ['repos', 'downloadZipballArchive']}],
        ...
        "removeProtectedBranchAppRestrictions": ['DELETE /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', {}, {'mapToData': 'apps'}],
        ...
        "removeProtectedBranchRequiredStatusChecksContexts": ['DELETE /repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', {}, {'mapToData': 'contexts'}],
        "removeProtectedBranchRestrictions": ['DELETE /repos/{owner}/{repo}/branches/{branch}/protection/restrictions'],
        "removeProtectedBranchTeamRestrictions": ['DELETE /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', {}, {'mapToData': 'teams'}],
        "removeProtectedBranchUserRestrictions": ['DELETE /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', {}, {'mapToData': 'users'}],
        "replaceProtectedBranchAppRestrictions": ['PUT /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps', {}, {'mapToData': 'apps'}],
        "replaceProtectedBranchRequiredStatusChecksContexts": ['PUT /repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts', {}, {'mapToData': 'contexts'}],
        "replaceProtectedBranchTeamRestrictions": ['PUT /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/teams', {}, {'mapToData': 'teams'}],
        "replaceProtectedBranchUserRestrictions": ['PUT /repos/{owner}/{repo}/branches/{branch}/protection/restrictions/users', {}, {'mapToData': 'users'}],
        ...
        "updateStatusChecksProtection": ['PATCH /repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks'],
        "removeStatusChecksProtection": ['DELETE /repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks'],
    },
    "search": {
    ...
    "users": {
        ...
        "createGpgKey": ['POST /user/gpg_keys', {}, {'renamed': ['users', 'createGpgKeyForAuthenticatedUser']}],
        "createPublicKey": ['POST /user/keys', {}, {'renamed': ['users', 'createPublicSshKeyForAuthenticatedUser']}],
        "deleteGpgKey": ['DELETE /user/gpg_keys/{gpg_key_id}', {}, {'renamed': ['users', 'deleteGpgKeyForAuthenticatedUser']}],
        "deletePublicKey": ['DELETE /user/keys/{key_id}', {}, {'renamed': ['users', 'deletePublicSshKeyForAuthenticatedUser']}],
        "getGpgKey": ['GET /user/gpg_keys/{gpg_key_id}', {}, {'renamed': ['users', 'getGpgKeyForAuthenticatedUser']}],
        "getPublicKey": ['GET /user/keys/{key_id}', {}, {'renamed': ['users', 'getPublicSshKeyForAuthenticatedUser']}],
        "listBlocked": ['GET /user/blocks', {}, {'renamed': ['users', 'listBlockedByAuthenticatedUser']}],
        "listEmails": ['GET /user/emails', {}, {'renamed': ['users', 'listEmailsForAuthenticatedUser']}],
        "listFollowingForAuthenticatedUser": ['GET /user/following', {}, {'renamed': ['users', 'listFollowedByAuthenticatedUser']}],
        "listGpgKeys": ['GET /user/gpg_keys', {}, {'renamed': ['users', 'listGpgKeysForAuthenticatedUser']}],
        "listPublicEmails": ['GET /user/public_emails'],
        "listPublicKeys": ['GET /user/keys', {}, {'renamed': ['users', 'listPublicSshKeysForAuthenticatedUser']}],
        "togglePrimaryEmailVisibility": ['PATCH /user/email/visibility', {}, {'renamed': ['users', 'setPrimaryEmailVisibilityForAuthenticatedUser']}],
        "addEmailsForAuthenticated": ['POST /user/emails'],
        "deleteEmailsForAuthenticated": ['DELETE /user/emails'],
    },
}
